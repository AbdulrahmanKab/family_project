        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="col-sm-3 row">
                    <label for="" class="col-sm-12">
                        الدولة
                        <input placeholder="الدولة" name="country" id="country" type="text" class="form-control">
                ...
                <div class="col-sm-3 row">
                    <label for="" class="col-sm-12">
                        المحافظة
                        <input placeholder="المحافظة" type="text" name="brief" id="brief" class="form-control">
                    ...
                    <label for="" class="col-sm-12">
                        ...
                        <div class="col-sm-3 ">
                            <label for="" style="width:100%">
                                المهنة
                                <select name="his_job" id="his_job" class="form-control">
